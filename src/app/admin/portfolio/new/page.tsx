...
export default function NewProjectPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (result.success) {
      ...
      setError(result.error || "Gagal menambah proyek.");
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex items-center justify-between">
        ...
        <h2 className="text-xl font-bold text-white">Tambah Proyek Baru</h2>
      </div>
        ...
        <div className="bg-secondary-dark/50 border border-white/5 rounded-3xl p-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <div className="space-y-2">
                ...
                <Input name="title" placeholder="Villa Modern Tropical..." required className="bg-surface border-white/10" />
             </div>
             <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <div className="space-y-2">
                ...
                <div className="relative">
                   <Input name="location" placeholder="Solo, Jawa Tengah" required className="bg-surface border-white/10 pl-11" />
          ...
          <div className="space-y-4">
             ...
             />
             <input type="hidden" name="gallery" defaultValue="[]" />
          </div>

          <div className="space-y-2">
            <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">Deskripsi Singkat</label>
            <Textarea name="description" placeholder="Ceritakan detail pengerjaan proyek ini..." className="bg-surface border-white/10 min-h-[150px]" />
          </div>
        </div>
